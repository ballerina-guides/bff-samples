...
const Page = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async ({ type, startFrom, endFrom }, helpers) => {
      try {
        const response = await postAPI(submitCargoUrl, { cargoType: type, startFrom, endFrom, id: createCargoId(), status: 'DOCKED', lat: getRandomInRange().toString(), lon: getRandomInRange().toString() }, {
          headers:
          {
